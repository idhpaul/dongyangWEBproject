						...
						<tr>
							...
							<td>
								<% if (booklist.getBookRental() == 1){ %>
									<input type="button" disabled="disabled" class="btn btn-danger" value="대여불가">
								<%}else{ %>
									<input type="button" class="btn btn-primary" value="대여" onclick="bookRental(<%=booklist.getBookID() %>)">
								<%} %>
							</td>
						</tr>
						<%} %>
