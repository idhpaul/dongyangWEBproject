		  ...
		  <div class="col-sm-7 c2">
			      <table class = "table" style = "text-align: center; border : 1px solid #dddddd">
						...
						<!-- 나중에 DB 데이터 불러올때 여기서 위와같이 페이지 파라메터 분석해서
						 ...
						 -->
						<tr>
							<td><img alt="책이미지나중에 이름기입" src="bookImage/01.jpg"></td>
							<td>dddddd</td>
							<td>강효석</td>
							<td>1995/02/15</td>
						</tr>
						<tr>
							<td><img alt="책이미지나중에 이름기입" src="bookImage/02.jpg"></td>
							<td>dddddd</td>
							<td>강효석</td>
							<td>1995/02/15</td>
						</tr>
						<tr>
							<td><img alt="책이미지나중에 이름기입" src="bookImage/03.jpg"></td>
							<td>dddddd</td>
							<td>강효석</td>
							<td>1995/02/15</td>
						</tr>
						<tr>
							<td><img alt="책이미지나중에 이름기입" src="bookImage/04.jpg"></td>
							<td>dddddd</td>
							<td>강효석</td>
							<td>1995/02/15</td>
						</tr>
